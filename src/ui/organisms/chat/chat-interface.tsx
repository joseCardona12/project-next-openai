...
import { useContextState,  useUserState } from "@/app/core/application/global-state";
import { OpenAiService } from "@/app/infrastructure/services";
import { IOpenAiResponseReply } from "@/app/core/application/dto";
...
export function ChatInterface() {
  ...
  return (
    <div className=" bg-white w-full max-w-2xl mx-auto h-[600px] flex flex-col rounded-lg shadow-md">
        ...
        {isLoading && (
          <div className="flex items-center">
            <div className="mr-2 bg-purple-100 rounded-full p-2">
              <SendHorizontal className="w-6 h-6 text-purple-600" />
            </div>
            <LoadingDots />
          </div>
        )}
